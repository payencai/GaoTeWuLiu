...
@Route(path = MyPath.Wuliu.NetSearch)
public class NetworkSearchActivity extends AppCompatActivity {
            ...
            public void onSuccess(String response) {
                ...
                if(result.getResultCode()==0){
                    ...
                    for (int i = 0; i <mapPointList.size() ; i++) {
                        ...
                        MapUtil.setMarker(NetworkSearchActivity.this,aMap,new LatLng(Double.parseDouble(mapPoint.getLatitude()),Double.parseDouble(mapPoint.getLongitude())),"");
                    }
                }else{
    ...
    @OnClick({R.id.rl_phone,R.id.rl_address,R.id.iv_back,R.id.tv_detail})
    void OnClick(View view){
        ...
        switch (view.getId()){
            case R.id.tv_detail:
                ARouter.getInstance().build(MyPath.Wuliu.NetDetail).navigation();
                break;
            case R.id.rl_phone:
