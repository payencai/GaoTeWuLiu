...
public class MyIndexStickyViewAdapter extends IndexStickyViewAdapter<WuliuCompany> {
    private Context context;
    public MyIndexStickyViewAdapter(List<WuliuCompany> list) {
        super(list);
    }
    public MyIndexStickyViewAdapter(List<WuliuCompany> list, Context context){
        this(list);
    ...
    @Override
    public void onBindContentViewHolder(RecyclerView.ViewHolder holder, int position, WuliuCompany itemData) {

        ContentViewHolder contentViewHolder = (ContentViewHolder) holder;
        contentViewHolder.mName.setText(itemData.getExName());
        //Glide.with(context).load(itemData.get()).into(contentViewHolder.mAvatar);
