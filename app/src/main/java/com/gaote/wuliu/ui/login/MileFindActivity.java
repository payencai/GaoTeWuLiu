...
public class MileFindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mile_find);
    ...
    private void findAccount(){
        HttpHeaders httpParams=new HttpHeaders();
        ...
        NetUtils.getInstance().post(Api.BASE_URL + Api.Manage.retrieveUserByAccountAndTel,httpParams, new OnMessageReceived() {
            @Override
