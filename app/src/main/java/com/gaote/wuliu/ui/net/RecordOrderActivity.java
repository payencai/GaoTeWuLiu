...
@Route(path = MyPath.Net.RecordOrder)
public class RecordOrderActivity extends AppCompatActivity implements NetRecordOrderView {
    ...
    NetRecordPresenter netConfirmPresenter;
    List<NetRecordOrder.ListBean> listBeanList;
    NetRecordAdapter netConfirmAdapter;
    int page=1;
    @Override
    ...
    private void initView() {
        ...
        netConfirmAdapter=new NetRecordAdapter(listBeanList);
        ...
        netConfirmAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if(view.getId()==R.id.item_rl_confirm){
                    NetRecordOrder.ListBean listBean=listBeanList.get(position);
        ...
        netConfirmPresenter=new NetRecordPresenter(this,new NetRecordOrderModel());
        netConfirmPresenter.getConifrmOrder(page);
    }
    private void showOrderDialog(String id,String time) {
        ...
        tv_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                netConfirmPresenter.confirmOrder(id);
            }
        });
        tvTitle.setText("确认收录吗？");
