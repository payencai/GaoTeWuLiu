package com.gaote.wuliu.widget;
...
public class ShadowView extends ViewGroup {
    ...
    public ShadowView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int shadowColor = a.getColor(R.styleable.ShadowView_containerShadowColor, Color.RED);
//        int shadowColor = Color.RED;
        float shadowRadius = a.getDimension(R.styleable.ShadowView_containerShadowRadius, 0);
        deltaLength = a.getDimension(R.styleable.ShadowView_containerDeltaLength, 0);
        cornerRadius = a.getDimension(R.styleable.ShadowView_containerCornerRadius, 0);
        float dx = a.getDimension(R.styleable.ShadowView_deltaX, 0);
        float dy = a.getDimension(R.styleable.ShadowView_deltaY, 0);
        drawShadow = a.getBoolean(R.styleable.ShadowView_enable, true);
        a.recycle();
